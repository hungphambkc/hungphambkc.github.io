  ...
  songs: [
    {
      ...
      singer: "Wizardrypro",
      path: "./assets/songs/Ai yêu Bác Hồ Chí Minh hơn thiếu niên nhi đồng (ST_ Phong Nhã) - Hoàng Quyên - Piano Cover.flac",
      image: "./assets/img/wizardrypro.jpg",
    },
    {
      name: "Ba ngọn nến lung linh (Cover by Wizardrypro)",
      singer: "Wizardrypro",
      path: "./assets/songs/Ba ngọn nến lung linh (ST- Ngọc Lễ) – Phương Thảo, Ngọc Lễ, Bé Na - Piano Cover wizardrypro.flac",
      image: "./assets/img/wizardrypro.jpg",
    },
    {
      name: "Bàn tay mẹ (Cover by Wizardrypro)",
      singer: "Wizardrypro",
      path: "./assets/songs/Bàn tay mẹ (ST_ Bùi Đình Thảo) (Hải Yến  Hà Linh) - Piano Cover wizardrypro.flac",
      image: "./assets/img/wizardrypro.jpg",
    },
    {
      name: "Beautiful In White (Cover by Wizardrypro)",
      singer: "Wizardrypro",
      path: "./assets/songs/Beautiful in white (hợp âm cảm âm) (ST_ Savan Kotecha, Arnpor Birgisson) – Shane Filan - Piano Cover.flac",
      image: "./assets/img/beautifulinwhite.jpg",
    },
    {
      name: "Cảm ơn con nhé (Về nhà đi con OST)",
      singer: "Wizardrypro",
      path: "./assets/songs/Cảm ơn con nhé (hợp âm cảm âm) (Về nhà đi con OST) - Quốc An - Piano Cover wizardrypro.flac",
      image: "./assets/img/wizardrypro.jpg",
    },
    {
    ...
    },
    {
      ...
      singer: "Wizardrypro",
      path: "./assets/songs/Chiếc đèn ông sao - piano solo wizardrypro.flac",
      image: "./assets/img/wizardrypro.jpg",
    },
    {
      name: "Có chàng trai viết lên cây (Phan Mạnh Quỳnh)",
      singer: "Wizardrypro",
      path: "./assets/songs/Có chàng trai viết lên cây (hợp âm cảm âm) (Phan Mạnh Quỳnh)(Mắt biếc OST) - Piano Cover wizardrypro.flac",
      image: "./assets/img/wizardrypro.jpg",
    },
    {
      name: "Đường đến ngày vinh quang (Ban nhạc Bức Tường)",
      singer: "Wizardrypro",
      path: "./assets/songs/Đường đến ngày vinh quang (hợp âm cảm âm) (ST_ Trần Lập) (Ban nhạc Bức Tường) - Piano Cover.flac",
      image: "./assets/img/wizardrypro.jpg",
    },
    {
      name: "Đường lên đỉnh núi (Tốp ca Đường lên đỉnh Olympia)",
      singer: "Wizardrypro",
      path: "./assets/songs/Đường lên đỉnh núi (hợp âm cảm âm) (ST_ Hoàng Vân) (Tốp ca Đường lên đỉnh Olympia) - Piano Cover.flac",
      image: "./assets/img/wizardrypro.jpg",
    },
    {
      name: "Em là hoa hồng nhỏ - Trịnh Công Sơn",
      singer: "Wizardrypro",
      path: "./assets/songs/Em là hoa hồng nhỏ (hợp âm cảm âm) - Trịnh Công Sơn - Piano Cover wizardrypro.flac",
      image: "./assets/img/wizardrypro.jpg",
    },
    {
    ...
    },
    {
      ...
      singer: "Wizardrypro",
      path: "./assets/songs/Last Christmas (hợp âm cảm âm) (George Michael) (Wham!) - Piano Cover wizardrypro.flac",
      image: "./assets/img/wizardrypro.jpg",
    },
    {
      name: "Mình cùng nhau đóng băng (Cover by Wizardrypro)",
      singer: "Wizardrypro",
      path: "./assets/songs/Mình cùng nhau đóng băng (hợp âm cảm âm) - Tiên Cookie - Thùy Chi - Piano Cover wizardrypro.flac",
      image: "./assets/img/minhcungnhaudongbang.jpg",
    },
    {
      name: "Nhật kí của mẹ (Hiền Thục)",
      singer: "Wizardrypro",
      path: "./assets/songs/Nhật kí của mẹ (ST_ Nguyễn Văn Chung) (Hiền Thục) - Piano Cover wizardrypro.flac",
      image: "./assets/img/wizardrypro.jpg",
    },
    {
    ...
    },
    {
      ...
      singer: "Wizardrypro",
      path: "./assets/songs/Thằng cuội - Tôi thấy hoa vàng trên cỏ xanh OST - piano solo wizardrypro.flac",
      image: "./assets/img/wizardrypro.jpg",
    },
    {
      name: "Tình yêu mặt trời (Cover by Wizardrypro)",
      singer: "Wizardrypro",
      path: "./assets/songs/Tình yêu mặt trời (ST_ ) - Piano Cover wizardrypro.flac",
      image: "./assets/img/wizardrypro.jpg",
    },
    {
      name: "Viên đá nhỏ (Cover by Wizardrypro)",
      singer: "Wizardrypro",
      path: "./assets/songs/Viên đá nhỏ (hợp âm cảm âm) (ST_ Ân Nhi) (Hải Băng) - Piano Cover wizardrypro.flac",
      image: "./assets/img/wizardrypro.jpg",
    },
    {
      name: "Wind",
